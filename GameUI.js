class GameUI {
    ...
    showGameOver(score, level) {
        ...
        // Choose image based on game end condition
        if (this.engine.overdose >= 100) {
            gameOverImage.src = 'assets/game_over/image.png';
        } else {
            gameOverImage.src = 'assets/game_over/image2.png';
        }
        ...
        // Set text based on game end condition
        gameOverText.textContent = this.engine.overdose >= 100 ? 'OVERDOSE' : 'GAME OVER';
